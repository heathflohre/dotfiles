...
read -p "Do you want to change the computer name? " -n 1 -r
echo    # (optional) move to a new line
if [[ $REPLY =~ ^[Yy]$ ]]
then
    read -p 'New name: ' COMPUTER_NAME
...
# Set standby delay to 3 hours (default is 3 hours on newer macOS versions).
...
# DARK MODE ON ONLY THE MENU BAR AND DOCK
# Set your desktop background to #171717 to match the dark menu bar
# http://mds.is/using-mojave-dark-mode-on-only-the-menu-bar-and-dock/
defaults write -g NSRequiresAquaSystemAppearance -bool Yes

# Disable transparency in the menu bar and elsewhere on Yosemite
# defaults write com.apple.universalaccess reduceTransparency -bool true

# Set Appearance to Orange
...
defaults write NSGlobalDomain AppleHighlightColor "1.000000 0.874510 0.701961"

# Set desktop picture
# sqlite3 ~/Library/Application\ Support/Dock/desktoppicture.db "update data set value = '/System/Library/PreferencePanes/DesktopScreenEffectsPref.prefPane/Contents/Resources/DesktopPictures.prefPane/Contents/Resources/Transparent.tiff'" && killall Dock
...
# Disable the macOS UI focus ring animations.
...
# Four-letter codes for the other view modes: `icnv` (Icon), `clmv` (Column), `Flwv` (Coverflow), `Nlsv` (List)
